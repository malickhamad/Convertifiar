...
<main class="bg-remover-page">
            ...
            <div class="container-fluid px-lg-4">
                ...
                <div class="upload-shell" id="uploadShell">
                    <div class="upload-card">
                        ...
                        <h2>Remove your
                            background</h2>
                        <p>Upload a photo and Xconvertifire
    ...
    <script type="module">
        ...
        let originalImage = null,
            ...
            shadow = false,
            outline = false;
        const API = window.Xconvertifire_BG_API || '';
        ...
        async function removeWithAI(file) {
            ...
            try {
                ...
                console.warn('Xconvertifire AI endpoint unavailable, using browser model.', e);
        ...
        async function process(file) {
            ...
            try {
                ...
                prog(8, API ? 'Connecting to Xconvertifire AI...' : 'Loading high-quality AI segmentation model...',
